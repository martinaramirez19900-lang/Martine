...
export const testimonialsTranslations = {
  ...
  pl: {
    title: 'Zaufanie traderów na całym świecie',
  ...
  cz: {
    title: 'Důvěra obchodníků po celém světě',
  ...
  tr: {
    title: 'Dünya çapında yatırımcılar tarafından güveniliyor',
  ...
  sk: {
    title: 'Dôvera obchodníkov po celom svete',
  ...
  es: {
    title: 'Confianza de traders en todo el mundo',
  ...
  af: {
    title: 'Vertrou deur handelaars wêreldwyd',
