// Additional translations to be merged into main translations
export const additionalMarketKeys = {
  en: {
    markets: {
  ...
  af: {
    nav: {
      ...
      fundingWithdrawals: 'Befondsing & Onttrekkings',
