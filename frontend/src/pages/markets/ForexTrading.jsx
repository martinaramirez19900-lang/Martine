    ...
    <div className="min-h-screen pt-20">
      <section className="py-20 px-4 bg-gradient-to-br from-gray-50 to-white">
        <div className="container mx-auto text-center">
          <h1 className="text-6xl font-bold text-gray-900 mb-6">{t.markets?.forex || 'Forex'} Trading</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Trade 70+ currency pairs with tight spreads and fast execution
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              { icon: Globe2, title: '70+ Pairs', desc: 'Major, minor and exotic currency pairs' },
              { icon: TrendingUp, title: 'Tight Spreads', desc: 'From 0.0 pips on major pairs' },
              { icon: DollarSign, title: 'High Leverage', desc: 'Up to 1:500 leverage available' }
            ].map((feature, idx) => (
